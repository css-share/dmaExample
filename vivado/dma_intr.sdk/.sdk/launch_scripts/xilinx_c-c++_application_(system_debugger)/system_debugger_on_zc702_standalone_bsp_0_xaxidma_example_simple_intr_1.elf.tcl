...
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent JTAG-SMT1 210203345589A"} -index 0
dow /proj/css/Krishna.M/dma_designs/simple_dma/simple_dma.sdk/standalone_bsp_0_xaxidma_example_simple_intr_1/Debug/standalone_bsp_0_xaxidma_example_simple_intr_1.elf
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent JTAG-SMT1 210203345589A"} -index 0
con
